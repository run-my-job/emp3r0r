...
## [4.0.0](https://github.com/run-my-job/emp3r0r/compare/v3.4.2...v4.0.0) (2025-11-30)
...
* `cat` command to dump file content in text or hex mode ([a995042](https://github.com/run-my-job/emp3r0r/commit/a99504207b4123d83fd37e71d6e542ae5b0996e0))
* `generate` command ([1e1e49d](https://github.com/run-my-job/emp3r0r/commit/1e1e49d84b5af057f4f8d6b08a9ff89922d5397f))
* `ps` with filters ([9a6c428](https://github.com/run-my-job/emp3r0r/commit/9a6c428e33661316426d76e921239a12efd84dff))
* add bind address option for port forwarding sessions, closes [#476](https://github.com/run-my-job/emp3r0r/issues/476) ([c4374aa](https://github.com/run-my-job/emp3r0r/commit/c4374aaf170faa1988dcd3bd9583c118349d485a))
* add ELF in-mem loader for Linux modules (WIP) ([5b62db8](https://github.com/run-my-job/emp3r0r/commit/5b62db85f75f3b479153daf933a98f409a7bb47f))
* agent command infrastructure now working ([2e7356d](https://github.com/run-my-job/emp3r0r/commit/2e7356df2a472ed8c38f240f01f05d2be29935bc))
* agent command structure, improve maintainability and readability ([494dbfa](https://github.com/run-my-job/emp3r0r/commit/494dbfa1917132de0b5b0145f9f655d22cc4f209))
* assign `cap_net_admin` to `emp3r0r-cc` when installing ([18db26c](https://github.com/run-my-job/emp3r0r/commit/18db26c4ebb716988fd019d494a31cd81d4404a8))
* auto-complete remote path names ([87c9225](https://github.com/run-my-job/emp3r0r/commit/87c9225e4d57c36457fbc4075a639f3406608b1c))
* command completers ([775b1c2](https://github.com/run-my-job/emp3r0r/commit/775b1c21d0f1dcbfef16025cbbf5ad4e123b2f6a))
* **generate:** enhance payload type descriptions for CGO support [#473](https://github.com/run-my-job/emp3r0r/issues/473) ([fdb6d33](https://github.com/run-my-job/emp3r0r/commit/fdb6d33f692370c47f53660da941db2304c2b4be))
* go_lpe ([fd524d0](https://github.com/run-my-job/emp3r0r/commit/fd524d071dd0a2817f3abe2b73ee4b2fddf49273))
* improve module config structure ([e5dea79](https://github.com/run-my-job/emp3r0r/commit/e5dea792a0df6f808349caa63ebca8dd774149c0))
* include listener in releases ([f96226d](https://github.com/run-my-job/emp3r0r/commit/f96226d21d4f8c3bbacff2c1dfde95c3323c3787))
* integrate `ss` package logging to C2 console ([aa26a49](https://github.com/run-my-job/emp3r0r/commit/aa26a49e14318d9cad1cf0f930ded91d129f4c59))
* integrate `util` logs ([dfc3257](https://github.com/run-my-job/emp3r0r/commit/dfc3257e135bd005ee5c10a064f996867f18b9fa))
* **kill:** enhance process killing functionality with improved error handling and support for multiple PIDs [#468](https://github.com/run-my-job/emp3r0r/issues/468) ([ddf0560](https://github.com/run-my-job/emp3r0r/commit/ddf05607bc250ff5e3a1be4da0a3d055cbdeb9b7))
* move command time to prompt ([30fa524](https://github.com/run-my-job/emp3r0r/commit/30fa524bdff700b5c28ffae6774bb2ccb746eacf))
* operator can pull config tarball from server via wireguard ([d872e59](https://github.com/run-my-job/emp3r0r/commit/d872e59a96b24df97d96abf883163672f07ac316))
* re-design console logging (WIP) ([aadd158](https://github.com/run-my-job/emp3r0r/commit/aadd158a9ee6bc33ba4757428fe5ee8026cabb5e))
* relay file transfer requests to operator ([012884e](https://github.com/run-my-job/emp3r0r/commit/012884e63f23b3d33b6b8f7df2aa6e7a59fa573e))
* relay message tunnel to operator ([eb3ac70](https://github.com/run-my-job/emp3r0r/commit/eb3ac702b7758175ff26acb33505098c1b2a18df))
* **release:** update permissions and enhance upload script with response handling ([6feaaff](https://github.com/run-my-job/emp3r0r/commit/6feaaff18d5800f7641243418c8e28289697f32c))
* remove agent system info pane ([4677a80](https://github.com/run-my-job/emp3r0r/commit/4677a8000436869554b3b39d242106fd9c11eefd))
* set up auto-completion during installation ([8d3553a](https://github.com/run-my-job/emp3r0r/commit/8d3553a521f4773485d42f57dc035654966eb137))
* support C2 plugins and module builder ([8eba6f5](https://github.com/run-my-job/emp3r0r/commit/8eba6f5291108d0ad0883837de0980fc07506944))
* support DLL/SO payload types ([d8a1c04](https://github.com/run-my-job/emp3r0r/commit/d8a1c0403c19d2e0aa21210eb55f80b8fb6ec7ae))
* support multiple operators ([99123f1](https://github.com/run-my-job/emp3r0r/commit/99123f137c41bb6731790139bbb9fed0d395b7a7))
* switching to https://github.com/reeflective/console ([619ea45](https://github.com/run-my-job/emp3r0r/commit/619ea450f348594086a570b446f5f821b71a3ee5))
* tar config dir for operator to use when server starts ([4c38418](https://github.com/run-my-job/emp3r0r/commit/4c3841844070ab825dd5ace3f6f6113ca7d60866))
* unify C2 logging ([9cd6284](https://github.com/run-my-job/emp3r0r/commit/9cd62845843d6f1852ce9a7ebcbcbb9128bc5351))
* unify logging in C2 ([790653c](https://github.com/run-my-job/emp3r0r/commit/790653c64fbfed82a581ba40545b3ef19c79fb48))
* v2 branch, re-designed command line and infrastructure ([3b3f111](https://github.com/run-my-job/emp3r0r/commit/3b3f11153c903814f027e041587083d4d15d9c48))
* wireguard auto-config as operator transport ([27c93ab](https://github.com/run-my-job/emp3r0r/commit/27c93ab7475a9c302999ae7c48af90b086b28ca0))
* wireguard operator ([a2016cf](https://github.com/run-my-job/emp3r0r/commit/a2016cf24f3c00c45704b5a35b886c89e81cde4c))
* wireguard operator management ([8d09db0](https://github.com/run-my-job/emp3r0r/commit/8d09db09cd6f17ef2fed0051dde9f14bfdcaca5b))
* wireguard-go ([ea73568](https://github.com/run-my-job/emp3r0r/commit/ea73568e54fc388c4e6fd1954a90e40032cff425))


### Bug Fixes

* [#393](https://github.com/run-my-job/emp3r0r/issues/393) use more precise binary patching for reliable config extraction ([88bda6d](https://github.com/run-my-job/emp3r0r/commit/88bda6d25d78f9e860ac6a023b4e5b5e28f8cd48))
* `--debug` build fails ([0eac8a0](https://github.com/run-my-job/emp3r0r/commit/0eac8a0e8aaf4c030f6e64bc068aec2716993223))
* `-h` not allowed ([a9cc467](https://github.com/run-my-job/emp3r0r/commit/a9cc4675b5358ed569ac51441d85c18aa0a08f0e))
* `AddNeededLib` no longer depends on `patchelf` program ([5983def](https://github.com/run-my-job/emp3r0r/commit/5983def174945d7204b79b9d8eb87a0f71bbe244))
* `cd` ([1a674e4](https://github.com/run-my-job/emp3r0r/commit/1a674e40c2a295ca16ff7b4bf308eabec0be6e1f))
* `copy_stub` is slow, move it out of `init` ([dc9bc84](https://github.com/run-my-job/emp3r0r/commit/dc9bc84d5f410d082b0424143e1ad0c9caa3808b))
* `elvish_win` not working ([2c3ef0d](https://github.com/run-my-job/emp3r0r/commit/2c3ef0dfa9963e7abc1040d699d5cde8f6c530c3))
* `emp3r0r.json` keys should match those in Go source code ([a7a04e7](https://github.com/run-my-job/emp3r0r/commit/a7a04e7c90ff5bdb90a08e9478de957202bcb571))
* `emp3r0r` builder should generate a version number to mark custom builds ([79493b8](https://github.com/run-my-job/emp3r0r/commit/79493b832c5deaecc355f8eeb7bad6f0633a4085))
* `exec` command conflicts with built-in commands such as `ls` ([bbc9361](https://github.com/run-my-job/emp3r0r/commit/bbc93619e9929d9bf6777e2508f5adc1ae34e003))
* `exec` should complain when no command is specified ([9381998](https://github.com/run-my-job/emp3r0r/commit/93819986d0392cc5f72120fd5fb9154cfd6aa684))
* `file_manager` not starting ([8aee534](https://github.com/run-my-job/emp3r0r/commit/8aee53450427457354d759023269a90ffa1a87e6))
* `ftp` token check ([ef15f7d](https://github.com/run-my-job/emp3r0r/commit/ef15f7dcc4891124bb2591b54de45f9eb14adeb2))
* `gen_agent` module initialization ([d652b0e](https://github.com/run-my-job/emp3r0r/commit/d652b0e48d85f14bbe1e1a5445322a425458a826))
* `get` and `put` file transfer features ([5bcb259](https://github.com/run-my-job/emp3r0r/commit/5bcb259643b7958e0c629c6b886d0bbb0b444480))
* `get` command blocks shell ([6a11b8a](https://github.com/run-my-job/emp3r0r/commit/6a11b8aa5a691fa02f468f557cd6e23edae20369))
* `get` download progress not showing ([4b349cc](https://github.com/run-my-job/emp3r0r/commit/4b349cc82b6f53380888f88dc6c3d454e9ac2fcf))
* `get` was messed up ([348819b](https://github.com/run-my-job/emp3r0r/commit/348819bdad5a15ad74396ad1e040f05a3a7942a0))
* `git` unable to get tag name in github action environment ([07b8a32](https://github.com/run-my-job/emp3r0r/commit/07b8a32901fbc64943a6e6ddf5711c282e8fe673))
* `go_lpe` takes too long ([fdd23b1](https://github.com/run-my-job/emp3r0r/commit/fdd23b14c39064ccd0d010bcd928da2aa5aed6a6))
* `help` command conflicts with cobra built-in help ([b2dc14b](https://github.com/run-my-job/emp3r0r/commit/b2dc14b2c37e0d2c57504c266875e6dcbed05f1e))
* `ls_modules`, `ls_port_fwds` commands ([abd58b5](https://github.com/run-my-job/emp3r0r/commit/abd58b5e24970db44044f78292601c8490438e96))
* `ls` error handling ([a20b025](https://github.com/run-my-job/emp3r0r/commit/a20b0256eba255be57b2b4f3a38a18da9beb6529))
* `mem_dump` should download dumped mem file ([3221840](https://github.com/run-my-job/emp3r0r/commit/32218402e6d53bbcb68ef2efb346076aeca22230))
* `peek_text` not returning code ([80d5ca8](https://github.com/run-my-job/emp3r0r/commit/80d5ca8baacadd036c57bb8d2218cc64bbcf5017))
* `put --dst` auto-complete ([f6e9f5a](https://github.com/run-my-job/emp3r0r/commit/f6e9f5a0bf0e59741b5f5cda7fbcd77046bcddbd))
* `put` sends empty checksum ([716f61b](https://github.com/run-my-job/emp3r0r/commit/716f61b35d37c923eb687c63ceae7bd88bc351df))
* `run_proxy` cmd sender ([1e854c0](https://github.com/run-my-job/emp3r0r/commit/1e854c088d54705400acd95d7980941965b071db))
* `search` command ([10210e0](https://github.com/run-my-job/emp3r0r/commit/10210e00f4ec0823cd016dd2278ad664be3b94f9))
* `set` command auto-complete `val` ([ad831dc](https://github.com/run-my-job/emp3r0r/commit/ad831dcbee71f4e484cb0c6fe9945804cdfc77f5))
* `ssh_harvester` can't be restarted ([ee4dfde](https://github.com/run-my-job/emp3r0r/commit/ee4dfde790c8fb9bfe6e44bbf0efe9e9d74c730f))
* `ssh_harvester` crashes sshd-session ([0c3a82d](https://github.com/run-my-job/emp3r0r/commit/0c3a82d53b53c07489092a67a35379e66644fd51))
* `ssh_harvester` should give real-time response ([3a07812](https://github.com/run-my-job/emp3r0r/commit/3a078124b77bd0a3a033aaccf1a3d4f8b4a0cd95))
* `ssh_harvester` should have a stop switch ([ea0d254](https://github.com/run-my-job/emp3r0r/commit/ea0d254cd01f7d8e47925ef35754d8eaab20f2d3))
* `ssh_harvester` should print passwords at the end of debugging session ([a05f281](https://github.com/run-my-job/emp3r0r/commit/a05f281f4554711c58d151a99fe5bf1d08a212de))
* `ssh_harvester` should take configurable code pattern ([5c0ab46](https://github.com/run-my-job/emp3r0r/commit/5c0ab46b750779e1a076cef0bd4931203b6e1224))
* `ssh_harvester` unable to find `sshd` process ([5c1de64](https://github.com/run-my-job/emp3r0r/commit/5c1de643ae5fa9e70cb585f050a81f35e6a58da1))
* `ssh` shells and port mapping ([4bcd79f](https://github.com/run-my-job/emp3r0r/commit/4bcd79fb79bb463870b9f076c844524d534d7e40))
* `stager` module should be able to read configurations from env vars ([ce22a03](https://github.com/run-my-job/emp3r0r/commit/ce22a03682cf40a8aaaf808313ef32184865defe))
* `upgrade_cc` fails to run in tmux ([1d13a2a](https://github.com/run-my-job/emp3r0r/commit/1d13a2a6e8dc5bcdf403fe7e403de143c447a143))
* `vaccine` installation fails: `patchelf` not found ([315ec2b](https://github.com/run-my-job/emp3r0r/commit/315ec2b38ba9f085ec1803989e6d79d966f315f7))
* 468 ([36d0457](https://github.com/run-my-job/emp3r0r/commit/36d045786c1f11feea9d3e91300062f613676847))
* add `!elf_patch` command to patch ELF files and load shared libraries, replacing `get_persistence` ([bf113f3](https://github.com/run-my-job/emp3r0r/commit/bf113f38188a5b944b401ac062b432da3be48803))
* add `tmux` as dependency ([82ceb3e](https://github.com/run-my-job/emp3r0r/commit/82ceb3eaf88e46864a14e47e2d14c944cce265ad))
* add target_path option to elf_patch command for custom library loading location ([dc2b009](https://github.com/run-my-job/emp3r0r/commit/dc2b009ecd4c1b807d7f575ddba286479e663fdd))
* agent crashes on command parsing error ([d17dc89](https://github.com/run-my-job/emp3r0r/commit/d17dc89356ea5800db6fffcd9133d4755fce4805))
* agent lost when C2 is re-built ([51c3ae2](https://github.com/run-my-job/emp3r0r/commit/51c3ae2788e4d07bef347a41b8436835fa82f347))
* agent response too noisy ([123258a](https://github.com/run-my-job/emp3r0r/commit/123258aef2b0bb2e46956d90339fe35ce2a9ce2a))
* all completers are run at once ([56403d0](https://github.com/run-my-job/emp3r0r/commit/56403d0b18f6d629095a5c028831aff6e8eb0d80))
* always print module details ([d9203c9](https://github.com/run-my-job/emp3r0r/commit/d9203c97b83439b9711b5686efc29891c24c7ee9))
* ask for SSH password to use the relayed C2 ([66af346](https://github.com/run-my-job/emp3r0r/commit/66af3466d38f2757a0de233017cf34628c0678a9))
* auto-complete agent names ([4280495](https://github.com/run-my-job/emp3r0r/commit/4280495db6e97c971f3a9be93e4432dbcf1f0e95))
* auto-complete remote dir ([23f3774](https://github.com/run-my-job/emp3r0r/commit/23f3774a8b852df3cd4a7a32e95382c3cba062d4))
* automatically stop existing emp3r0r instance and prompt user to reopen after updating ([c23bab6](https://github.com/run-my-job/emp3r0r/commit/c23bab6bf5977aa04dacdbaca81ffd861059b043))
* build as `windowsgui` if target is Windows ([33ca2f6](https://github.com/run-my-job/emp3r0r/commit/33ca2f6444ec6e99ab0b8486705167ee1133e41b))
* bump version ([e0b4c99](https://github.com/run-my-job/emp3r0r/commit/e0b4c99ec2e99e9e9cd381afd99a1a448c56e010))
* c2 relay via SSH should use a different random password ([28ba2e4](https://github.com/run-my-job/emp3r0r/commit/28ba2e4be2cf48a1edd109b18a586c0535302f5e))
* carapace calls `listRemoteDir` too often ([7a01328](https://github.com/run-my-job/emp3r0r/commit/7a01328941ef732a3a310787504ed063125b2211))
* clarify error message for missing C2 server IP in WireGuard connection ([0dcf091](https://github.com/run-my-job/emp3r0r/commit/0dcf091a5704547f3eee86a25f489520b380b2a9))
* cleanup deprecated API related code ([1e7989b](https://github.com/run-my-job/emp3r0r/commit/1e7989bdc7a17b126424934259289f3059faf26e))
* CLI commands handling refactored ([394e5e4](https://github.com/run-my-job/emp3r0r/commit/394e5e42d03c449c94235145bd419db410aeecfa))
* command auto-completion broken after selecting a target ([8583b2c](https://github.com/run-my-job/emp3r0r/commit/8583b2ce1e61994b5bf08c94195bc3f1e7be85fe))
* command parsing errors ([f1c22c6](https://github.com/run-my-job/emp3r0r/commit/f1c22c67eb00d7912697fc35299dfc503b122d90))
* command sender in `ftp` package ([6d3a96f](https://github.com/run-my-job/emp3r0r/commit/6d3a96f2ace89e4a995cb8d4adbc164e68802940))
* command time tracking ([030639d](https://github.com/run-my-job/emp3r0r/commit/030639d45a6ee439a5cad67ec7178d4f78f8c466))
* conditional C2 connection should wait in seconds not minutes ([874dab1](https://github.com/run-my-job/emp3r0r/commit/874dab1827619f0d7baf179c5e0a030d78566b91))
* consider `darwin` even we are not supporting it ([4a736e2](https://github.com/run-my-job/emp3r0r/commit/4a736e2e6ce63cabb4c57985d0292247bac9b5d4))
* copilot deleted my code, fucking retard! ([4548470](https://github.com/run-my-job/emp3r0r/commit/4548470b772de423f97bdb1fe97c58af91c5c3bd))
* copy timestamps from ELF file to SO file in ElfPatcher function ([4b6fdb8](https://github.com/run-my-job/emp3r0r/commit/4b6fdb8eddea662aaf7a1a6c62214089036c7c51))
* crash ([4d3df48](https://github.com/run-my-job/emp3r0r/commit/4d3df48c757415eddf4ae9102340559c3cbfb5ec))
* crash when `set` an unknown option ([5e8ebf4](https://github.com/run-my-job/emp3r0r/commit/5e8ebf4fca6d3e9592ebf9639857da7cdab940fc))
* crash when using local modules ([490f309](https://github.com/run-my-job/emp3r0r/commit/490f309d6178be4c0676cfb77b915098babc7e5f))
* create `CGO`-enabled agent for DLL/SO types ([cd1ad3b](https://github.com/run-my-job/emp3r0r/commit/cd1ad3b3523002d865822cfe059c8a7184c94f8a))
* critical bug: `emp3r0r.json` gets overwritten every time `cc` starts ([8259507](https://github.com/run-my-job/emp3r0r/commit/825950737b5a90a029d7ce97cb9a1d4a3e15f701))
* deprecate `upx`, users should deliver compressed payloads by themselves ([d10a2f8](https://github.com/run-my-job/emp3r0r/commit/d10a2f812743bb29cf41688ee28d34d8e60b7ad4))
* deprecated package option of release-please ([ef82c2e](https://github.com/run-my-job/emp3r0r/commit/ef82c2efebd5c29c4be0c30db037fa2e7a19aa7d))
* disable `daemonizae` in Windows ([0902b70](https://github.com/run-my-job/emp3r0r/commit/0902b70acc643e1b2c879d7e19b4e49d4065b177))
* display `cd` errors ([59d5682](https://github.com/run-my-job/emp3r0r/commit/59d568245bc9ad395d1ca397dc3904959dce5d62))
* display full command in cmd response ([2e1d51b](https://github.com/run-my-job/emp3r0r/commit/2e1d51bf43f44315c5e9bbb6cb29dc8f5861f765))
* do not download again if already downloaded and checksum matched ([aa9ec97](https://github.com/run-my-job/emp3r0r/commit/aa9ec976838e1693edc18f9548b4d464767efee8))
* do not download file when memdump fails ([2445006](https://github.com/run-my-job/emp3r0r/commit/244500618e1a60da8865b0f4bf2e6bdf3d41de73))
* do not log if run as agent ([6325a67](https://github.com/run-my-job/emp3r0r/commit/6325a67597fec882832350694432beb2cc415c62))
* do not validate upload response ([d06922a](https://github.com/run-my-job/emp3r0r/commit/d06922ab29aecd453b29ab1b4a201ab1d9545dde))
* download from peer should be disabled when address is empty ([86b5659](https://github.com/run-my-job/emp3r0r/commit/86b5659244a276d242d2d486a2a1478221e6c4ea))
* drop `-s` when building debug version ([20e11e5](https://github.com/run-my-job/emp3r0r/commit/20e11e51f76e505d93ac57eaffcea4b23f7ab8b6))
* duplicated items in history search ([f2db9da](https://github.com/run-my-job/emp3r0r/commit/f2db9da2bba4c450416ee6eb0f655f0d1d6aa180))
* enhance logging messages for server startup with success indicators ([f26796d](https://github.com/run-my-job/emp3r0r/commit/f26796d232862ac333d426687e9d9f7347eeae45))
* ensure tmux title truncation to 10 characters ([d5e819b](https://github.com/run-my-job/emp3r0r/commit/d5e819bf708cd59771ae4456a2a863e11357397e))
* existing config file causes operator to fail ([4bea0ef](https://github.com/run-my-job/emp3r0r/commit/4bea0efe074355b3fd5f813625292bf37eb48cbd))
* fuck release-please ([f33992b](https://github.com/run-my-job/emp3r0r/commit/f33992b55e10a75bcc7f2b1ae392f61bf7401fd9))
* go-console fails to build for arm64 ([5faa4fc](https://github.com/run-my-job/emp3r0r/commit/5faa4fcd78257448012ba18e4fdce5980767f4ce))
* high CPU usage when searching for agent root path ([462d6f9](https://github.com/run-my-job/emp3r0r/commit/462d6f9d8f795e41070d641a9b0f757035c48b00))
* import cycle ([2e8ed9d](https://github.com/run-my-job/emp3r0r/commit/2e8ed9dbec7aba2a369e0ff56f012a2062118c5d))
* interactive modules "failed to upload" ([924dbca](https://github.com/run-my-job/emp3r0r/commit/924dbcaaea0217f095bada162171473d7842cbae))
* interactive modules file not found in Windows ([7d2e4c8](https://github.com/run-my-job/emp3r0r/commit/7d2e4c82e20484a7edc30f7b7d0f73e2ed6e5fb4))
* interactive modules not opening ([7ccbefb](https://github.com/run-my-job/emp3r0r/commit/7ccbefbcc978d6c1b7e3cd709063492766c339a2))
* lack of some useful readline features ([dac383f](https://github.com/run-my-job/emp3r0r/commit/dac383f6a3c59e86a1310e93707d646ba67458d6))
* linux shared libs linked with musl seems broken ([360efe8](https://github.com/run-my-job/emp3r0r/commit/360efe8fbe98075496a7add013b660c0732af9d6))
* log file path ([709c32f](https://github.com/run-my-job/emp3r0r/commit/709c32f051c2fe0bb88ee19a4d3ee285a0adf62c))
* log msg format ([04b95fc](https://github.com/run-my-job/emp3r0r/commit/04b95fca10cdeacd8c630070a4b97b82b76c35ef))
* log to `emp3r0r.log` and tmux window ([f902ed5](https://github.com/run-my-job/emp3r0r/commit/f902ed5ea4f2fb427b924551e363b3a96d2fd9a7))
* logging level ([56fe118](https://github.com/run-my-job/emp3r0r/commit/56fe118c59b74ed8257ea597b67c6233b7488621))
* logging not working ([6fc43f1](https://github.com/run-my-job/emp3r0r/commit/6fc43f1ae441f79bac72e6138ed962aae9fa8efd))
* make prompt string more informative ([7e432d2](https://github.com/run-my-job/emp3r0r/commit/7e432d260f28c26896f750648a343cec4857bdca))
* make sure commands have UUID for tracking ([08b89b0](https://github.com/run-my-job/emp3r0r/commit/08b89b0b319d079854b05e64ab9231feceec940c))
* make use of `is_local` attribute ([2a80931](https://github.com/run-my-job/emp3r0r/commit/2a809310863443a037da6cea1d84d8cf93d0b260))
* mismatched args ([dd9d6fb](https://github.com/run-my-job/emp3r0r/commit/dd9d6fb186d1fb5e92bd1bf2914b33d1c54b92b6))
* module builder ([2751c49](https://github.com/run-my-job/emp3r0r/commit/2751c499a08ceac6cb96f8f1d85556391e9a713b))
* module configurable options incomplete when listed ([0d51615](https://github.com/run-my-job/emp3r0r/commit/0d51615d618ca67bc6e65afd42f54effeef264c1))
* module management should load all modules into one map ([62c4adf](https://github.com/run-my-job/emp3r0r/commit/62c4adfd5471db88c6ca726c5abb6e639ec82809))
* module path handling ([0a375c8](https://github.com/run-my-job/emp3r0r/commit/0a375c8d1e36d5f36003d1e2440a621e957c4d65))
* **moduleCmd:** improve error handling for ActiveModule and command execution [#474](https://github.com/run-my-job/emp3r0r/issues/474) ([06c0c5e](https://github.com/run-my-job/emp3r0r/commit/06c0c5e65a2e4a2f4b9b02edc7a42c708252f27f))
* modules should be able to run from operator ([a837e4f](https://github.com/run-my-job/emp3r0r/commit/a837e4fb7351a3c4d812c74209783ef683b878f2))
* modules should not block ([1655958](https://github.com/run-my-job/emp3r0r/commit/16559587f1678467a82a5f689a2a33c8961876c7))
* need a reliable way to check if the agent is run as DLL ([330a0b6](https://github.com/run-my-job/emp3r0r/commit/330a0b6a4db441b20d0fc1f171260e792138eb2c))
* no CGO when building executables ([4d73434](https://github.com/run-my-job/emp3r0r/commit/4d73434a0dc66d61f47a5ba9565438fad7edf80d))
* no output from `stager` ([51a99ff](https://github.com/run-my-job/emp3r0r/commit/51a99ff33db81914671e9a0233f3f21d82e08e8c))
* no time to read fatal error messages ([b8ddd50](https://github.com/run-my-job/emp3r0r/commit/b8ddd50bad247cb9c04321fc9f307659de381530))
* only print printable bytes ([76f248f](https://github.com/run-my-job/emp3r0r/commit/76f248fcaea3b129a7c176f2f1f77da7dd996bfb))
* operator needs to pull the latest certs from server every time it runs ([b330ee6](https://github.com/run-my-job/emp3r0r/commit/b330ee6a9e67f4ebe4b5e306c4f34df91989671e))
* optimize HTTP2 connections ([91fcd5a](https://github.com/run-my-job/emp3r0r/commit/91fcd5ac584c4761fb71f650083de8179a7f9fb9))
* passing args to modules ([e08222c](https://github.com/run-my-job/emp3r0r/commit/e08222c96fbb4aa7cdf2cf430f0a64759f420f07))
* port mapping crash ([af550a6](https://github.com/run-my-job/emp3r0r/commit/af550a6986135adcde10e246b6d02947dcf2c95c))
* printing too many messages in console pane messes the prompt up ([80efe4e](https://github.com/run-my-job/emp3r0r/commit/80efe4e7430262be4c7a70d34a43c9e7f55462c0))
* randomize `MagicString` ([4bf2f96](https://github.com/run-my-job/emp3r0r/commit/4bf2f9666f443b1bc8503fdf8ad00a43b8286245))
* recursive `get`, useful when downloading a directory on a target ([36696e5](https://github.com/run-my-job/emp3r0r/commit/36696e55e4dda23433d7310a92f04465ac687ae9))
* recursive dowloads should retain directory structure ([20d8bda](https://github.com/run-my-job/emp3r0r/commit/20d8bda469ec138a7bb15c27e943ec17e97c7869))
* redesign modules and fix errors ([c90ed00](https://github.com/run-my-job/emp3r0r/commit/c90ed0013105eed9f360466fca3e0f1a8823c9d4))
* reduce waiting time for ssh based shells ([4dada94](https://github.com/run-my-job/emp3r0r/commit/4dada945be5b0981a291b9a38852241b7b7c5ab2))
* refactor C code, integrate `stager` into one of the modules ([a53f78c](https://github.com/run-my-job/emp3r0r/commit/a53f78cd310eb0f1e10b0976d715f76d063f60ad))
* refactor cmd line usage ([84ec8c3](https://github.com/run-my-job/emp3r0r/commit/84ec8c3314baa5e06b62cf28922d05aac4e32cc0))
* refactor module config structure ([bf38b05](https://github.com/run-my-job/emp3r0r/commit/bf38b05e6e7a3c4d244f61ad591fc46b25e2e796))
* regex filter for recursive downloads ([1443b01](https://github.com/run-my-job/emp3r0r/commit/1443b0144fb6eadef89b385f57ca44ac86a4a3a8))
* release-please not updating version number ([ce078b3](https://github.com/run-my-job/emp3r0r/commit/ce078b3d787075a47b6809908d159710ec060345))
* remove shadowsocks c2 transport ([22cba84](https://github.com/run-my-job/emp3r0r/commit/22cba84bb9013517cb5e6ea0768d3702ade58fa1))
* remove unused dependencies and simplify line wrapping functionality ([71db5e3](https://github.com/run-my-job/emp3r0r/commit/71db5e346b8040001b2c12144248015aaa856262))
* resize tmux pane to fit table output ([f74d434](https://github.com/run-my-job/emp3r0r/commit/f74d4346612014be5c232c484ac1c303805d1998))
* restrict to 1 task per download for recursive downloads, enforce checksum verification ([7f66130](https://github.com/run-my-job/emp3r0r/commit/7f661306352711898fb655b187f034e1435aae59))
* return an empty process list if none matches the filter ([9403915](https://github.com/run-my-job/emp3r0r/commit/9403915f0f8e162ff3e45cae8fefbb76e7637e69))
* return process output of in-memory ELF modules ([63cd991](https://github.com/run-my-job/emp3r0r/commit/63cd9914d9d01485c1a1bb6d8bd1352a83f8a3c8))
* run ELF in subroutine ([91279bf](https://github.com/run-my-job/emp3r0r/commit/91279bff261857c28ac9321dc3bbcbbfbd3164d4))
* run jobs in the background to prevent blocking ([317be9c](https://github.com/run-my-job/emp3r0r/commit/317be9cf63c7c2f4f64369e390204500d6b8182a))
* screenshot ([45d7eaf](https://github.com/run-my-job/emp3r0r/commit/45d7eafd8375664a3c860ec56dc6163746cfce0e))
* search `c:\` when run as priviliged user ([4cc1dc0](https://github.com/run-my-job/emp3r0r/commit/4cc1dc0e8546be469f1eaf21efcc28937a4b3f15))
* self purging doesn't need to notify CC ([ba11ec7](https://github.com/run-my-job/emp3r0r/commit/ba11ec7e1ce6fdf52396735f8b0c03d1b3503078))
* **server:** add command generation for client connections and improve usage instructions ([c5437c2](https://github.com/run-my-job/emp3r0r/commit/c5437c2bfb53e1ca6de31c90a90e424cab336f02))
* set active agent (WIP) ([01b9840](https://github.com/run-my-job/emp3r0r/commit/01b98408caae14f9ffb6a527a75ede7f7ca5e227))
* set env vars for module builder ([ba3a10a](https://github.com/run-my-job/emp3r0r/commit/ba3a10a84b36a75afed49bc6534732948ffe2434))
* should check if any files fail to download in recursive downloads ([08427dd](https://github.com/run-my-job/emp3r0r/commit/08427dd67e26df19734503bdaaf7b839b4854dd5))
* simplify agent binary patching ([8f3e9a1](https://github.com/run-my-job/emp3r0r/commit/8f3e9a1d1438d2fc56403862816cc64a563fe068))
* simplify ssh c2 relay ([f280459](https://github.com/run-my-job/emp3r0r/commit/f28045920152b7dab28d2ea2c0dc7eddf7580289))
* simplify table rendering and add reset layout command ([ca5c066](https://github.com/run-my-job/emp3r0r/commit/ca5c0669a6e469cbcd2d669e2af050379c5c16d8))
* some agent commands have no runners ([6575f5c](https://github.com/run-my-job/emp3r0r/commit/6575f5cbcd935c9455600d1e95ee00186705a17a))
* some flags should be marked as required ([4813b5f](https://github.com/run-my-job/emp3r0r/commit/4813b5ff3da354a151bf10d3e9edf11849931695))
* some noticeable latency in agent list refreshing ([c5b4d71](https://github.com/run-my-job/emp3r0r/commit/c5b4d71ac5b62cee471cd3a2c5c140c31d47e0db))
* sometimes agent can't send back response ([d1a0388](https://github.com/run-my-job/emp3r0r/commit/d1a03883ef1cc9c026d73740928a271cc62070ee))
* specify the register to read password from ([09c44ad](https://github.com/run-my-job/emp3r0r/commit/09c44ad9e3904b5784a9b3e453fb6648f1a8ed8e))
* support more arch for shared obj building ([dd16baa](https://github.com/run-my-job/emp3r0r/commit/dd16baa2b2dc75979689d1daefe6f3e23bcbd3c8))
* support more arch when building `linux_so` ([9a39895](https://github.com/run-my-job/emp3r0r/commit/9a39895797f9e3c4f20a14cb129fb7c14ccadc40))
* syntax highlighting of emp3r0r console ([e7ffe1a](https://github.com/run-my-job/emp3r0r/commit/e7ffe1abc7903f57a5582102f73d216407e32c9d))
* time spent on commands should be printed after command responses ([36f7e38](https://github.com/run-my-job/emp3r0r/commit/36f7e38a6b5788b1538fc96a0106b146e1dd6ad5))
* tmux init ([c79cce5](https://github.com/run-my-job/emp3r0r/commit/c79cce542c575c28205ff40b887f8e2e3ccc7cca))
* **tmux:** add pane layout reset functionality and improve pane size constraints ([a9b8c23](https://github.com/run-my-job/emp3r0r/commit/a9b8c23b8e1bcda367d2a8f7a31b1c30894bdc09))
* transport string for kcp incorrect ([890d126](https://github.com/run-my-job/emp3r0r/commit/890d126f2f975f8f508b6273b7f0c81016c2f11b))
* unable to get `SUDO_USER` when installing ([743fffe](https://github.com/run-my-job/emp3r0r/commit/743fffe8fde7b86e7a43339cf20a706cb8a41d30))
* unify logging ([b073c38](https://github.com/run-my-job/emp3r0r/commit/b073c3822c0116f6b113e722b4d91c3bf7567b87))
* unify server response to unauthorized requests ([1146adc](https://github.com/run-my-job/emp3r0r/commit/1146adcd634946a48e5371dcbb7f4810dc040094))
* uninstall shell completion files as well ([2e1a7c1](https://github.com/run-my-job/emp3r0r/commit/2e1a7c12cfdaea180f4ab6b7a7e60c255d75e788))
* update carapace dependency and remove obsolete references ([bfcf031](https://github.com/run-my-job/emp3r0r/commit/bfcf0319ebb7205e7c0b4ab8a9f9eada9aa5c43e))
* update command formatting for client connection commands and improve readability ([679b312](https://github.com/run-my-job/emp3r0r/commit/679b312b7cd57e36122d6e8f31bfd9a4651f4b73))
* update deps ([cfaac67](https://github.com/run-my-job/emp3r0r/commit/cfaac675bde3aca7e46b4c113d0d3e64b3eedbe0))
* update deps, remove deprecated `go-ps` ([94812c3](https://github.com/run-my-job/emp3r0r/commit/94812c372c5298234f7b5c677825050a13e8d00f))
* update version number ([25e518b](https://github.com/run-my-job/emp3r0r/commit/25e518bebf022604fffc5d360167c8d9a549a718))
* upgrade `github.com/jm33-m0/arc` to `v2` ([3a12a5d](https://github.com/run-my-job/emp3r0r/commit/3a12a5d376fc470daf6220669a097aa4d2093e0b))
* usage for commands ([60fd189](https://github.com/run-my-job/emp3r0r/commit/60fd189d6fbe1b68881bd27ce9e655acd14f6a43))
* use `zig` to avoid cross-compiling nightmare ([a919132](https://github.com/run-my-job/emp3r0r/commit/a919132a8c71eaf24bb6512106f0fc79b73cc11d))
* use minidump on Windows to be more useful ([e5f7ae2](https://github.com/run-my-job/emp3r0r/commit/e5f7ae296b0526343fef0bb69218d36a853d9af4))
* UX in starting server ([3408aa7](https://github.com/run-my-job/emp3r0r/commit/3408aa7001f46eac7e90e0d2055c9d6e271aee3a))
* version number ([355aca8](https://github.com/run-my-job/emp3r0r/commit/355aca85b6fe865ba02018c8e50b839ade7e2c37))
* version number not updating ([5732f25](https://github.com/run-my-job/emp3r0r/commit/5732f253782a08f71b12cc8355bff5ecc8295e07))
* wg IPs not random ([19684f7](https://github.com/run-my-job/emp3r0r/commit/19684f7b6e4df8a91143b1784382e6567ecbcdca))


### Code Refactoring

* separate `core` and `server`, adopting operator-server mode (WIP) ([d4d52b1](https://github.com/run-my-job/emp3r0r/commit/d4d52b1372122fd6bf9847349f09ddf8c2ef1de5))
